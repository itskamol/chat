...
const MessageSchema: Schema = new Schema(
    ...
    fileUrl: { // URL of the uploaded file from file-service
        type: String,
        required: function(this: IMessage) { return this.type !== 'text'; }, // Required if not a text message
    },
    fileName: { // Original name of the file, as confirmed by file-service
        type: String,
        required: function(this: IMessage) { return this.type !== 'text'; },
    },
...
MessageSchema.pre<IMessage>('save', function (next) {
    ...
    if (this.type !== 'text' && this.fileUrl && !this.content && this.fileName) {
